...
```
```
{ "commandType": 25, "commandInput": [ { "name": "Narzut do podsumy", "discount_type": 1, "discount_unit": 1, "value": 3 }, { "name": "Opust do podsumy", "discount_type": 0, "discount_unit": 1, "value": 5 } ] }
```
